...
const corsOptions: cors.CorsOptions = {
  ...
  exposedHeaders: ['X-Usage-Info', 'RateLimit-Limit', 'RateLimit-Remaining', 'RateLimit-Reset'],
};
const startServer = async () => {
  ...
  // ─── Auth ───────────────────────────────────────────────────────────
  // SECURITY: Strict rate limiting on auth endpoints
  app.post('/api/auth/google', strictRateLimitMiddleware, googleAuthHandler);
  app.get( '/api/auth/google', googleRedirectHandler);
  app.get( '/api/auth/google/callback', googleCallbackHandler);
  app.post('/api/auth/login', strictRateLimitMiddleware, loginHandler);
  app.post('/api/auth/password-reset/request', strictRateLimitMiddleware, passwordResetRequestHandler);
  app.post('/api/auth/password-reset/submit', strictRateLimitMiddleware, passwordResetSubmitHandler);
  app.post('/api/auth/signup', strictRateLimitMiddleware, signupHandler);
