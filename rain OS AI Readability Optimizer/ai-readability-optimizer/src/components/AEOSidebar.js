...
const AEOSidebar = () => {
  ...
  const tabs = [
    { id: 'overview', label: __('Overview', 'ai-readability-optimizer') },
    { id: 'actions', label: __('Actions', 'ai-readability-optimizer') },
    { id: 'metrics', label: __('Metrics', 'ai-readability-optimizer') },
    { id: 'history', label: __('History', 'ai-readability-optimizer') },
  ];
