    ...
    <div className="rain-os-overview-tab">
      ...
      >
        {isAnalyzing ? (
          <>
            ...
            {__('Analyzing...', 'ai-readability-optimizer')}
          </>
        ) : (
          __('Analyze Content', 'ai-readability-optimizer')
        )}
      </button>
      ...
      {recommendations.length > 0 && (
        <>
          <div className="rain-os-section-header">
            {__('Recommendations', 'ai-readability-optimizer')}
          </div>
      ...
      {!analysisData && !isAnalyzing && (
        <div style={{ 
          ...
          {__('Click "Analyze Content" to get your AI Readability score and recommendations.', 'ai-readability-optimizer')}
        </div>
      )}
    </div>
  );
